...
//    private FileManager fileManager;
     ...
     * @Return com.yupi.yupicturebackend.model.vo.PictureVO
     * @Since version-1.0
     */
    @Override
...
//            ThrowUtils.throwIf(!exists, ErrorCode.NOT_FOUND_ERROR, "图片不存在");
    ...
    /*
     * @Author winku
     * @Date 2025/2/14 20:08
     * @Description 分页获取图片封装
     * @Param [picturePage, request]
     * @Return com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.yupi.yupicturebackend.model.vo.PictureVO>
     * @Since version-1.0
     */
    @Override
    ...
    /*
     * @Author winku
     * @Date 2025/2/14 20:25
     * @Description 校验图片，由于更新和修改图片时进行判断
     * @Param [picture]
     * @Return void
     * @Since version-1.0
     */
    ...
    /*
     * @Author winku
     * @Date 2025/2/18 18:39
     * @Description 批量抓取和创建图片
     * @Param [pictureUploadByBatchRequest, loginUser]
     * @Return java.lang.Integer 成功创建的图片数
     * @Since version-1.0
     */
    @Override
